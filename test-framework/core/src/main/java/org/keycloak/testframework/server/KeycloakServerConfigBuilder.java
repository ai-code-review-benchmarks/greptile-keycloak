...
public class KeycloakServerConfigBuilder {
    ...
    public KeycloakServerConfigBuilder setHttpPort(int httpPort) {
        this.httpPort = httpPort;
        return this;
    }

    public KeycloakServerConfigBuilder httpPort() {
        return option("http-port", String.valueOf(this.httpPort));
    }
